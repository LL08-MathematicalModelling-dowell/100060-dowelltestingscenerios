...
def insert_broadcast(video_privacy_status: str, test_name_value: str, youtube, scheduled_start_time: datetime = None) -> str:
    """
...
def insert_stream(youtube) -> dict:
    ...
    try:
        ...
        new_stream_ingestion_address = ingestion_info.get(
            'ingestionAddress')  # ("rtmpsIngestionAddress", "")
